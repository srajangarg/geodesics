...
public:
    ...
    virtual void propagate(std::vector<SurfacePoint> &sources,
                           ...
                           = GEODESIC_INF, // propagation algorithm stops after
                                           // reaching the certain distance from
                                           // the source
    ...
    void geodesic(std::vector<SurfacePoint> &sources,
                  ...
                  std::vector<std::vector<SurfacePoint>> &paths); // lazy people
                                                                  // can find
                                                                  // geodesic
                                                                  // paths with
                                                                  // one
    ...
    virtual unsigned
    best_source(SurfacePoint &point, // after propagation step is done, quickly
                                     // find what source this point belongs to
                                     // and what is the distance to this source
...
protected:
    ...
    std::vector<stop_vertex_with_distace_type> m_stop_vertices; // algorithm
                                                                // stops
                                                                // propagation
                                                                // after
                                                                // covering
