...
public:
    ...
    void find_closest_point(double const x, double const y, double &offset,
                            double &distance); // find the point on the interval
    ...
    void initialize(edge_pointer edge, SurfacePoint *point = NULL,
