...
public:
    ...
    typedef typename VertexList::reverse_iterator
        VertexReverseIterator; ///< Reverse iterator over vertices.
    typedef typename VertexList::const_reverse_iterator
        VertexConstReverseIterator; ///< Const reverse iterator over vertices.
    ...
    typedef typename EdgeList::reverse_iterator
        EdgeReverseIterator; ///< Reverse iterator over edges.
    typedef typename EdgeList::const_reverse_iterator
        EdgeConstReverseIterator; ///< Const reverse iterator over edges.
     ...
     * points to a valid edge of the face. */
    Edge const *getSuccessor(EdgeConstIterator edge) const
    {
        return const_cast<MeshFace *>(this)->getSuccessor(edge);
    }
    ...
    VertexConstReverseIterator verticesReverseBegin() const
    {
        return vertices.rbegin();
    }

    /** Get a reverse iterator pointing to the last vertex. */
    VertexReverseIterator verticesReverseBegin()
    {
        return vertices.rbegin();
    }
     ...
     */
    VertexConstReverseIterator verticesReverseEnd() const
    {
    ...
    /** Get a reverse iterator pointing to the position before the first vertex.
     */
    VertexReverseIterator verticesReverseEnd()
    {
        return vertices.rend();
    }
    ...
    EdgeConstReverseIterator edgesReverseBegin() const
    {
        return edges.rbegin();
    }

    /** Get a reverse iterator pointing to the last edge. */
    EdgeReverseIterator edgesReverseBegin()
    {
        return edges.rbegin();
    }
     ...
     */
    EdgeConstReverseIterator edgesReverseEnd() const
    {
        return edges.rend();
    }
    ...
    /** Get a reverse iterator pointing to the position before the first edge.
     */
    EdgeReverseIterator edgesReverseEnd()
    {
        return edges.rend();
    }
    ...
    {
        debugAssertM(vertices.size() == edges.size(),
                     "MeshFace: Numbers of edges != number of vertices");
...
private:
    ...
    VertexIterator removeVertex(VertexIterator loc)
    {
